...
internal static class ChatFormat
{
    ...
    /// <summary>
    ///     Strip color placeholders from a message (used for console output where
    ///     chat control characters render as garbage).
    /// </summary>
